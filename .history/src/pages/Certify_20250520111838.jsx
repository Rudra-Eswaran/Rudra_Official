...
const Certify = () => {
  ...
  useEffect(() => {
    const loadCertificates = () => {
      ...
      const images = Array.from({ length: numCertificates }, (_, i) => `/assets/Certificates/${activeCategory}/C${i + 1}.jpg`);
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-blue-700 text-white p-4">
      ...
      <div className="relative w-full max-w-[620px] h-[420px] bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden border-4 border-blue-600">
        {certificates.length > 0 ? (
          <AnimatePresence mode="wait">
            <motion.img
              ...
              className="w-[600px] h-[400px] object-contain p-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
        ...
        {certificates.length > 1 && (
          <>
            <motion.button
              ...
              className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-blue-600 p-2 rounded-full opacity-80 hover:opacity-100 transition duration-300"
            >
            ...
            <motion.button
              ...
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 p-2 rounded-full opacity-80 hover:opacity-100 transition duration-300"
            >
