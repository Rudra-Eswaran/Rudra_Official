  ...
  return (
    <section id="services" className="relative bg-blue-600 text-white py-20 px-4 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        {/* Loader overlay inside services container */}
        {loading && (
          <div className="absolute inset-0 bg-blue-600 bg-opacity-60 flex flex-col items-center justify-center rounded-xl z-50">
