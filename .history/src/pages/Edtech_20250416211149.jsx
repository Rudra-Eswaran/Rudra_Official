...
const Edtech = () => {
  ...
  useEffect(() => {
    ...
    // Refresh AOS when the component is mounted or re-mounted
    AOS.refresh();

    return () => {
      AOS.refresh(); // Clean up on unmount to prevent memory leaks
    };
  }, []);
    ...
    >
      ...
      {isLoading ? (
        ...
        <div className="text-center" data-aos="fade-up">
          {/* Main Content */}
          <h1 className="text-4xl font-semibold text-purple-800 mb-4" data-aos="fade-up" data-aos-delay="100">
            EdTech Services
          </h1>
          <p
