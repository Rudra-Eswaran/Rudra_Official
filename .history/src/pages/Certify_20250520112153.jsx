...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-blue-500 text-white p-4">
      ...
      {/* Container with fixed aspect ratio for consistent sizing */}
      <div className="relative w-full max-w-2xl aspect-w-4 aspect-h-3 bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden border-4 border-blue-600 p-6">
