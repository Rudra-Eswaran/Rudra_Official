...
import { FiPhone, FiMail, FiMapPin } from "react-icons/fi"; // Using react-icons for Phone, Email, Location
import { CONTACT_INFO, FORM_FIELDS, BUTTON_LABELS } from "../Constants"; // Import constants
import SuccessMessage from "../components/Success"; // Import SuccessMessage
import FailureMessage from "../components/Failure"; // Import FailureMessage
...
const Contactus = ({ scrollToFooter }) => {
  ...
  return (
    ...
    >
      ...
      {messageStatus === "success" && <SuccessMessage onClose={() => setMessageStatus("")} />}
      {messageStatus === "failure" && <FailureMessage onClose={() => setMessageStatus("")} />}
    </motion.section>
  );
};
