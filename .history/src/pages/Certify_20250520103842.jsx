      ...
      <div className="flex flex-wrap justify-center gap-4 max-w-5xl mb-8">
        {certificateCategories.map((cat) => (
          <button
            ...
            className={`px-5 py-2 rounded-md font-semibold transition-colors duration-300 border-2 border-black
              ${
                activeCategory === cat
                  ? "bg-black text-white"
        ...
        {certificates.length > 1 && (
          <>
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 bg-white text-black p-3 rounded-full shadow-md hover:bg-black hover:text-white transition"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 bg-white text-black p-3 rounded-full shadow-md hover:bg-black hover:text-white transition"
