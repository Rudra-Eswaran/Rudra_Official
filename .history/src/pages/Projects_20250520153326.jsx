...
import pythonIcon from "../assets/python.svg"; // add python icon file
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10">
        {/* Categories as pills */}
        <nav className="flex gap-4 overflow-x-auto mb-6 md:flex-col md:w-48">
          {categories.map((cat) => (
            <button
              key={cat}
        ...
        {/* Projects grid */}
        <main className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-8">
          <AnimatePresence>
