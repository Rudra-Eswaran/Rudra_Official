...
const About = () => {
  ...
  return (
    <div
      id="about"
      className="bg-blue-600 min-h-screen flex flex-col md:flex-row items-center justify-center px-4 sm:px-6 md:px-8 py-16 gap-12 overflow-x-hidden max-w-full"
    >
      <motion.div
        ...
        className="w-full max-w-full md:max-w-lg text-white text-center md:text-left"
      >
