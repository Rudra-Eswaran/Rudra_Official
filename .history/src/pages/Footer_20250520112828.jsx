    ...
    <footer className="bg-blue-600 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 text-center md:text-left">
            ...
            <div>
              ...
              <ul>
                <li>
                  <p className="text-sm">Email: <span className="text-blue-200">info@rudra.com</span></p>
                </li>
                <li>
                  <p className="text-sm">Phone: <span className="text-blue-200">+91 9345152042</span></p>
                </li>
                <li>
                  <p className="text-sm">Address: <span className="text-blue-200">Tamil Nadu, India</span></p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="text-center mt-8">
          <p className="text-sm">&copy; {new Date().getFullYear()} Eswaran Suyampraksam. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
