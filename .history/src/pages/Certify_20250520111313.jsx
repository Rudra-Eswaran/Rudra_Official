...
const Certify = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-4rem)] flex flex-col items-center justify-center bg-purple-600 text-white p-4">
      ...
      <motion.div className="text-lg md:text-xl font-semibold bg-purple-700 px-4 py-2 rounded-lg shadow-md mb-4">
      ...
      <div className="relative w-full max-w-3xl h-[450px] bg-white rounded-lg shadow-lg flex justify-center items-center overflow-hidden">
        {certificates.length > 0 ? (
          ...
          <motion.p className="text-center text-purple-900 text-xl">
