...
import { CONTACT_INFO, MODAL_MESSAGES, FORM_FIELDS, BUTTON_LABELS } from "../Constantsconstants"; // Import constants
      ...
      <div className="relative container mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-5xl pb-0 mb-0">
        <div className="space-y-6">
          {Object.keys(CONTACT_INFO).map((key) => (
            <InfoBox
              key={key}
              icon={<FiMapPin />} // Replace with dynamic icon based on key
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-60">
          ...
          >
            ...
            <h4 className="text-xl font-bold mb-2 text-green-600">{MODAL_MESSAGES.success.title}</h4>
