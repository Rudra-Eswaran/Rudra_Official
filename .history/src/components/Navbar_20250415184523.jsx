      ...
      <div className="container-fluid px-4 md:px-6 mx-auto flex justify-between items-center">
        ...
        <ul className="hidden md:flex space-x-8 text-lg font-medium text-blue-800">
          ...
          <li className="relative group">
            ...
            <ul className="absolute left-0 hidden mt-2 space-y-2 bg-white shadow-lg text-blue-800 p-4 rounded-lg w-48 group-hover:block transition-all duration-300 ease-in-out opacity-0 group-hover:opacity-100">
              <li>
                <Link
                  to="/products"
