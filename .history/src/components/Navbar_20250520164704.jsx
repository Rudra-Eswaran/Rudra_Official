...
const Navbar = () => {
  ...
  const menuItems = [
    ...
    { name: "Rudrans", path: "/rudrans" }, // Updated from Team to Rudrans and path corrected
  ...
  return (
    <nav className="fixed w-full top-0 left-0 z-50 mt-4 px-6 rounded-lg bg-white transition-shadow duration-300 shadow-md">
