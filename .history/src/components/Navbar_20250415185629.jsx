...
const Navbar = () => {
  ...
  return (
    <nav
      ...
      } px-4 shadow-[0px_4px_8px_0px_rgba(0,0,255,0.2)] mx-4`} // Added mx-4 to add space around the navbar (external margin)
    >
      <div className="container-fluid md:px-6 mx-auto flex justify-between items-center">
        {/* Logo */}
        ...
        <ul className="hidden md:flex space-x-8 text-lg font-medium text-blue-800">
          ...
          <li className="relative">
            ...
            >
              Services
              <span className="ml-1 text-lg">{isOpen ? "▲" : "▼"}</span> {/* Chevron Arrow */}
            </button>
            {isOpen && (
              <ul className="absolute left-0 mt-2 space-y-2 bg-white shadow-lg text-blue-800 p-4 rounded-lg w-48">
                <li>
                  <Link
                    to="/products"
      ...
      {isOpen && (
        <ul className="md:hidden bg-white text-blue-800 p-6 space-y-4">
          ...
          <li className="relative">
            ...
            >
              Services <span className="ml-1 text-lg">{isOpen ? "▲" : "▼"}</span> {/* Chevron Arrow */}
            </button>
            {isOpen && (
