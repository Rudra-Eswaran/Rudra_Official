...
const Navbar = () => {
  ...
  // Only the actual pages you want in menu (exclude Home if it's separate route)
  const menuItems = [
  ...
  return (
    <nav
      className={`fixed w-full top-0 left-0 z-50 mt-4 px-6 rounded-lg bg-white transition-shadow duration-300 shadow-md`}
    >
