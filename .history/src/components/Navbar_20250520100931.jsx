  ...
  return (
    <>
      ...
      <div
        ...
        className={`relative rounded-xl transition-shadow duration-700 ease-in-out ${
      ...
      >
        <nav className="max-w-7xl mx-auto flex justify-between items-center px-0 md:px-0">
          {/* Logo */}
          <div>
